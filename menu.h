...
void StartMenu(RenderWindow& game, bool& firstwhile) {
	...
	//додавання текстур, об'єктів і фону (з файлу)
	...
	//цикл меню. Завантажується і створюється подія. Також описується натиск на кнопку. 
	while (isMenu) {
		Event event;
		...
		//Створення нової гри з усіма властивостями
		...
		//Створення перешкод з усіма властивостями
		...
		//Вимальовування нової гри, карти та виходу
		game.draw(New_game);
		game.draw(Highboard);
		game.draw(Exit);
...
void Menu(RenderWindow& game, int score, List& lst, bool& firstwhile) {
	...
	//Створення питання та властивостей
...
void EnterName(RenderWindow& game, int score, List& lst) {
	...
	//Створення питання з усіма властивостями
	question.setString("What is your name?:");
	question.setCharacterSize(25);
	question.setFillColor(Color(0, 0, 0, 255));
	question.setPosition(90, 150);

	//Створення ім'я з усіма властивостями
